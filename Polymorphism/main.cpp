//Ðåàëèçîâàòü ïðîãðàììó äåìîíñòðèðóþùóþ ïðåäìåòíóþ îáëàñòü "Ïèööåðèÿ"
//
//Çàêàç - ýòî ñïèñîê èç âûáðàííûõ ïîëüçîâàòåëåì ïèöö.
//
//Ïèööà - ýòî áëþäî, êîòîðîå âûáèðàåò ïîëüçîâàòåëü.Ïèööà îáëàäàåò èìåíåì(òåêñò), îïèñàíèåì(òåêñò), ðàçìåðîì(îäèí èç âàðèàíòîâ 25, 30, 35, 40, êîòîðûé âûáèðàåò ïîëüçîâàòåëü), öåíîé(çàâèñèò îò ðàçìåðà âûáðàííîé ïèööû è èíãðåäèåíòîâ).Ïîëüçîâàòåëü ìîæåò ïîäñîëèòü ëþáóþ ïèööó N - ðàç èëè äîáàâèòü ñûðà M - ðàç - ýòî óâåëè÷èâàåò öåíó â çàâèñèìîñòè îò âèäà è ðàçìåðà ïèööû(ôîðìóëó ïðèäóìàòü íà âàøå óñìîòðåíèå)
//
//Çàêàç - ôîðìèðóåòñÿ ïîëüçîâàòåëåì ÷åðåç êîíñîëü, âîçìîæíîñòü äîáàâèòü ïèööó, ðàñïå÷àòàòü çàêàç â êîíñîëü.
//
//Ïå÷àòü çàêàçà - âûâîä âñåãî ñïèñêà âûáðàííûõ ïîëüçîâàòåëåì ïèöö, ñ óêàçàíèåì íàçâàíèÿ, îïèñàíèÿ, N - ñîëè è M - ñûðà, ðàçìåðà ïèööû è ñòîèìîñòè ïèööû ñ ó÷¸òîì âñåõ ïàðàìåòðîâ
//
//Â êîíöå ðàñïå÷àòàííîãî çàêàçà âûâåñòè èòîãîâóþ ñóììó çà çàêàç
#include <iostream>
#include <string>
#include <vector>
